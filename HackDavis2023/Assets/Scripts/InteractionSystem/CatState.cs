...
public class CatState
{
    ...
    public string GeneratePrompt()
    {
        ...
        return $"{initialPrompt}{Environment.NewLine}" +
               ...
               $"The conversation so far has been:{currentConversation.ToString()}" +
               ...
               $"{locationPrompt}" + 
               $"{Environment.NewLine}IMPORTANT: First give your verbal only response. Try to keep the conversation going" +
               $". If you want to move locations, write only the location name surrounded by parenthesis on a new line. You move at most once.";
    }
}
